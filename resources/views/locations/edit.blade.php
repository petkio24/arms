...
@section('title', isset($location) ? 'Редактирование ' . $location->name : 'Новое помещение')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">
                        {{ isset($location) ? 'Редактирование помещения' : 'Добавление нового помещения' }}
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ isset($location) ? route('locations.update', $location) : route('locations.store') }}"
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                ...
                                {{ isset($location) ? 'Сохранить изменения' : 'Добавить помещение' }}
                            </button>
                        </div>
                    </form>
                </div>
